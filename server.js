...
app.get("/scrape", function (req, res) {
  ...
  request(website, function (error, response, html) {
    ...
    $("div.headline").each(function (i, element) {
      ...
      // var link = website + $(element).children("h2").children("a").attr("href");
      result.link = website + $(this).children("h2").children("a").attr("href");
      // var summary = $(element).children("h5").text();
